const kanban = {
    ...
    methods: {
        async getKanbanItems(){
            const response = await axios.get(issues_kanban_url)
    ...
    <div class="container-fluid">
      <div class="card card-table-sm mt-3">
